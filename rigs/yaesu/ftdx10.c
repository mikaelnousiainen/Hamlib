...
#undef NO_LVL_RFPOWER
    ...
    .filters =            {
        ...
        {FTDX10_CW_RTTY_PKT_RX_MODES,  Hz(3000)},   /* CW, RTTY, PKT/USER */
        {FTDX10_CW_RTTY_PKT_RX_MODES,  Hz(3200)},   /* CW, RTTY, PKT/USER */
        {FTDX10_CW_RTTY_PKT_RX_MODES,  Hz(3500)},   /* CW, RTTY, PKT/USER */
        {FTDX10_CW_RTTY_PKT_RX_MODES,  Hz(4000)},   /* CW, RTTY, PKT/USER */
